        ...
        <section className="w-full h-[calc(100vh-4rem)] flex justify-center max-lg:py-10 py-20 max-sm:py-25">
            <div className="sm:max-w-[70%] max-w-[80%] h-[100%] flex flex-col items-center gap-5 sm:gap-10">
                ...
                <div className="flex flex-col items-center sm:flex-row md:mt-5 md:gap-8 gap-3 sm:gap-5">
                    <button className="bg-transparent border-2 border-[#7e8182] text-[#7e8182] font-medium rounded-full px-6 py-2 sm:px-8 sm:py-3 cursor-pointer hover:text-white hover:bg-[#7e8182] transition-all duration-500 w-fit max-sm:text-sm">Start Reading</button>
                    <button className="text-white bg-[#7e8182] rounded-full px-7 py-2 sm:px-10 sm:py-3 font-medium border-2 border-[#7e8182] cursor-pointer hover:bg-white hover:text-[#7e8182] transition-all duration-500 w-fit max-sm:text-sm">Write a Blog</button>
                </div>
            </div>
        </section>
    )
